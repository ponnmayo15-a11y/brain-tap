import { saveScore, loadScores } from "./scores.js?v=19";
import { startFlash } from "./games/flash.js?v=19";
import { startReverse } from "./games/reverse.js?v=19";
import { startNback } from "./games/nback.js?v=19";
