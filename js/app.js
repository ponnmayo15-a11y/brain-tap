import { saveScore, loadScores } from "./scores.js?v=20";
import { startFlash } from "./games/flash.js?v=20";
import { startReverse } from "./games/reverse.js?v=20";
import { startNback } from "./games/nback.js?v=20";
