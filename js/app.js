import { saveScore, loadScores } from "./scores.js?v=21";
import { startFlash } from "./games/flash.js?v=21";
import { startReverse } from "./games/reverse.js?v=21";
import { startNback } from "./games/nback.js?v=21";
